...
| Режим | Интернет | Провайдер | Скорость |
|-------|----------|-----------|----------|
| `fallback` (по умолч.) | опционально | Perplexity → Qwen | 1–4 сек |
| `local` | ❌ полный offline | Ollama/Qwen | 2–4 сек |
| `cloud` | ✅ | Perplexity | 1–2 сек |
| `parallel` | ✅ | оба, быстрейший | <1 сек |

Подробнее: [`docs/local-llm.md`](docs/local-llm.md)
